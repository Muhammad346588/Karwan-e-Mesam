...
const PackagesCard = ({ activeCategory }) => {
  ...
  const packagesData = [
    {
      id: 1,
      title: "Ashura Special Ziyarat 2026 (Iraq Only)",
      category: "iraq-iran",
      duration: "10-12 Days",
      price: "$1,300",
      hasGroundOption: true,
      groundPrice: "$550",
      lastBookingDate: "May 28, 2026",
      badge: "Ashura Special",
      stayDetail1: "Najaf Premium Near Haram",
      stayDetail2: "Karbala Holy Walking Distance",
      features: [
        "Complete Air Travel (By Air)",
        "Luxury Hotel Accommodations",
        "3-Time Catering Meals (Standard)",
        "Experienced Guide Accompanied",
    ...
    {
      id: 2,
      title: "Ashura Special Grand Mix Tour (Iran + Iraq)",
      category: "mix",
      duration: "20-22 Days",
      price: "$1,500",
